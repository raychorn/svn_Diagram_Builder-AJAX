		...
		<!--
			...
			function drawWaferData() {
				...
				if ( (!!oChannelsSel) && (!!oCoordsSourceSel) && ((sel = oChannelsSel.selectedIndex) > -1) && ((selCoordsSource = oCoordsSourceSel.selectedIndex) > -1) && (!!global_qData) && (!!oDiagramFrame) ) {
					global_qData.iterateRecObjs(displayRecords);
						...
						if (!!oO) {
							...
							if (!!qData) {
								...
								if (!bool_isAnyErrorRecords) {
									...
									_html += '<span class="normalStatusBoldClass">Coords Source:</span>&nbsp;<select id="selection_coordsSource" class="codeSmallerNoBorder" onchange="drawWaferData(); return false;">';
