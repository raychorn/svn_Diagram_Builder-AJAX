<cfapplication name="DiagramBuilder_App_001" clientmanagement="Yes" sessionmanagement="Yes" clientstorage="clientvars" setclientcookies="No" setdomaincookies="No" sessiontimeout="#CreateTimeSpan(0,1,0,0)#" applicationtimeout="#CreateTimeSpan(1,0,0,0)#" loginstorage="Session">
...
<cfscript>
	...
	Request.isColdFusionProductVersion6 = (ListFirst(Server.ColdFusion.ProductVersion, ',') eq '6');
