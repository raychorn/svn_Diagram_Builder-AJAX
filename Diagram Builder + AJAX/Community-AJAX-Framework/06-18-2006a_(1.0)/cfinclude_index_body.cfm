...
// +++
	...
	//		html += '<span class="normalx12StatusBoldClass"><a href="" onclick="alert(\'More Info will be added soon.\'); return false;">More info &gt;&gt;</a></span>';
			...
			html += '<br>';
			// mailto:ajax-sales@contentopia.net
			html += '<span class="normalx12StatusBoldClass"><a href="" onclick="displayContactUsContentIn(\'div_contactUsContent\', \'performContactUsAction\'); return false;">ajax-sales@contentopia.net</a></span>';
