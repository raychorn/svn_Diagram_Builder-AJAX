...
<cfif (1)>
	...
	<cfif (bool_sessionLoggedin) OR 1>
								<td>
									&nbsp;|&nbsp;
									...
									<button name="btn_purchasePremiumButton" id="btn_purchasePremiumButton" type="button" class="premiumButtonClass" onclick="this.disabled = true; performOpenLoginRegisterWindow(this.id, '#_url#'); return false;">Premium Account</button>
								</td>
	</cfif>
							</tr>
						</table>
