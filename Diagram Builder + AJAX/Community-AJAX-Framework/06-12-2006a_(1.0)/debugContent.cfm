	...
	<cfif (Request.commonCode.isServerLocal())>
								...
								<td>
									...
									<cfif 0>
										...
										<button name="btn_registerButton" id="btn_registerButton" type="submit" class="registerButtonClass3" onclick="this.disabled = true; var oTD = _$('td_loginRegisterFrame'); var oFrame = _$('iframe_loginRegisterFrame'); if ( (!!oTD) && (!!oFrame) ) {  oTD.style.display = const_inline_style; oFrame.src = '#_url#'; }; return false;"><img src="#_urlImg#" height="20" border="0"></button>
									<cfelse>
										<button name="btn_registerButton" id="btn_registerButton" type="submit" class="registerButtonClass" onclick="this.disabled = true; performOpenLoginRegisterWindow('#_url#'); return false;">Register</button>
									</cfif>
								</td>
							</tr>
						</table>
