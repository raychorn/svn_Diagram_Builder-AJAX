<cfoutput>
	...
	<!--
		...
		var js_urlParentPrefix = '#Request._urlParentPrefix#';
		...
		<tr>
			<td valign="top">
				<table width="100%" cellpadding="-1" cellspacing="-1">
					<tr>
						<td background="#Request._urlParentPrefix#/AJAX-Framework/images/DiagramBuilder/h_blue.gif">&nbsp;</td>
						<td colspan="2" align="left" <cfif (cf_currentBlogName IS 'default') AND 0>bgcolor="#cf_blogBgColor#"<cfelse>background="#Request._urlParentPrefix#/AJAX-Framework/images/DiagramBuilder/h_blue.gif"</cfif>>
