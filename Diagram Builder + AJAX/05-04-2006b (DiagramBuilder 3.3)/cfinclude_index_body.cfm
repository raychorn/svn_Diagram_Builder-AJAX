					...
					if (!!qData) {
						...
						if (!!oO) {
							...
							if (!bool_isAnyErrorRecords) {
								...
								_html += '<br><br>';
								_html += '<span class="normalSmallStatusBoldClass">Data Channel:</span>&nbsp;<select id="selection_channels" class="textEntryClass" title="Choose a Metrics Channel to Draw the Wafer..." onchange="global_tidChannel = setInterval(\'delayedAction(drawWaferToScale)\', 250); return false;">';
