...
<cferror type="EXCEPTION" template="onError.cfm" mailto="raychorn@gmail.com" exception="any">
<cferror type="REQUEST" template="onError.cfm" mailto="raychorn@gmail.com" exception="any">
<cferror type="VALIDATION" template="onError.cfm" mailto="raychorn@gmail.com" exception="any">
