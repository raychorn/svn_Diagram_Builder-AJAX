...
// +++
			...
			function handle_display_WaferRecordsBrowserGUI(oBtn) {
				...
				//	doAJAX_func('processMetricsFileFromDb', 'handleProcessMetricsFileFromDb(' + oAJAXEngine.js_global_varName + ')', 'metricsFileName', oSel.options[0].text);
				//	doAJAX_func('getWaferFromDbStatus', 'handleWaferFromDbStatus(' + oAJAXEngine.js_global_varName + ')', 'waferName', oSel.options[0].text);
				//	doAJAX_func('getWaferDataFromDb', 'handleProcessMetricsFileFromDb(' + oAJAXEngine.js_global_varName + ')', 'waferName', oSel.options[0].text, 'channelName', 'CHANNEL1');
