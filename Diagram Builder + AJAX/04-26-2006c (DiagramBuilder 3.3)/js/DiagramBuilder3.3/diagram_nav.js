...
{ this.ID="Pix"+_N_Pix; _N_Pix++; _zIndex++;
  ...
  this.MoveTo=_DotMoveTo;
  this.Delete=_Delete;
  _DiagramTarget.document.writeln("<layer id='"+this.ID+"' left="+eval(theX+this.dX)+" top="+eval(theY+this.dY)+" z-Index="+_zIndex+"><layer left=0 top=0 width=1 height=2 bgcolor="+theColor+"><img src='" + _DiagramImagesHref + "transparent.gif' width=1 height=2></layer></layer>");
  return(this);
}
