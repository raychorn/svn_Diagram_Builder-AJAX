...
function initAJAXEngine() {
	...
	oAJAXEngine.onReceive = function (){
		...
		window.status = byteCount + ' bytes received from AJAX.';
...
function showAJAXBegins(sMsg, sImage, imageHeight) {
	...
	if (!!cObj) {
		...
		resp += '<link rel=stylesheet type="text/css" href="' + document.location.href + 'StyleSheet.css">';
		resp += '</head><body>';
		resp += ajaxBegins();
...
{ var x0,y0,i,j,itext,l,x,y,r,u,fn,dx,dy,xr,yr,invdifx,invdify,deltax,deltay,id=this.ID,lay=0,selObj="",divtext="",ii=0,oo,k,sub,sshift;
  ...
  if (_IsImage(theDrawColor))
    divtext="<div id='"+this.ID+"i"+eval(ii++)+"' "+EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute; left:"+eval(this.left)+"px; width:"+eval(this.right-this.left+_dSize)+"px; top:"+eval(this.top)+"px; height:"+eval(this.bottom-this.top+_dSize)+"px; color:"+theTextColor+"; border-style:solid; border-width:1px; z-index:"+this.zIndex+"'><img src='"+_DiagramImagesHref+theDrawColor+"' width="+eval(this.right-this.left-1)+" height="+eval(this.bottom-this.top-1)+"></div>";
  else
...
{ this.ID="Bar"+_N_Bar; _N_Bar++; _zIndex++;
  ...
  if (_nvl(theText,"")!="")
  { var tt=theText;
    if (_IsImage(theText)) tt="<img src='"+_DiagramImagesHref+theText+"' width="+eval(theRight-theLeft-1)+" height="+eval(theBottom-theTop-1)+">";
...
var _debug$ = false;
function dom_Box(theLeft, theTop, theRight, theBottom, theDrawColor, theText, theTextColor, theBorderWidth, theBorderColor, theTooltipText, theOnClickAction, theOnMouseoverAction, theOnMouseoutAction)
{ this.ID="Box"+_N_Box; _N_Box++; _zIndex++;
  this.left=theLeft;
  this.top=theTop;
  this.width=Math.abs(theRight-theLeft);
  this.height=Math.abs(theBottom-theTop);
  this.DrawColor=theDrawColor;
  this.Text=String(theText);
  this.TextColor=theTextColor;
  ...
  if (_nvl(theText,"")!="")
  { var tt=theText;
    if (_IsImage(theText)) tt="<img src='"+_DiagramImagesHref+theText+"' width="+eval(this.width-(2*ww))+" height="+eval(this.height-(2*ww))+">";
...
{ var id=this.ID, selObj;
  ...
  { var ww=0;
    ...
    tt="<img src='"+_DiagramImagesHref+theText+"' width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+">";
  }
  selObj.innerHTML=tt;
}
...
{ this.Size=theSize;
  ...
  { _DiagramTarget.document.write("<div style='position:absolute;left:0px;top:0px;width:"+this.Size+"px;height:"+this.Size+"px;background-color:"+theColor+";font-size:1pt;line-height:1pt;'>");
    _DiagramTarget.document.write("<img src='"+_DiagramImagesHref+theType+"' width="+this.Size+"px height="+this.Size+"px style='vertical-align:bottom'></div>");
  }
  else
  { if (theType%6==0)
...
{ this.Color=theColor;
  ...
  { tt+="<div style='position:absolute;left:0px;top:0px;width:"+this.Size+"px;height:"+this.Size+"px;background-color:"+theColor+";font-size:1pt;line-height:1pt;'>";
    tt+="<img src='"+_DiagramImagesHref+theType+"' width="+this.Size+"px height="+this.Size+"px style='vertical-align:bottom'></div>";
  } 
  else
  { if (this.Type%6==0)
...
function dom_Pixel(theX, theY, theColor)
{ this.ID="Pix"+_N_Pix; _N_Pix++; _zIndex++;
  ...
  this.MoveTo=_DotMoveTo;
  this.Delete=_Delete;
  _DiagramTarget.document.writeln("<div id='"+this.ID+"' style='position:absolute;left:"+eval(theX-this.dX)+"px;top:"+eval(theY-this.dY)+"px;width:" + pixel_width + "px;height:" + pixel_height + "px;background-color:"+theColor+";font-size:1pt;z-index:"+_zIndex+"'></div>");
  return(this);
}
...
{ this.ID="Area"+_N_Area; _N_Area++; _zIndex++;
  ...
  if (theBase<=tt)
  { if ((theBase<tt)&&(ww>0))
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "o_"+theColor+".gif' width="+ww+"px height="+eval(tt-theBase)+"px style='vertical-align:bottom'></div>");
    if (((theY0<theY1)&&(theX0<theX1))||((theY0>theY1)&&(theX0>theX1)))
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:"+eval(tt-theBase)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "q_"+theColor+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>");
    if (((theY0>theY1)&&(theX0<theX1))||((theY0<theY1)&&(theX0>theX1)))
  ...
  { dd=Math.round((theBase-tt)/hh*ww);
    if (((theY0<theY1)&&(theX0<theX1))||((theY0>theY1)&&(theX0>theX1)))
    { _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "b_"+theColor+".gif' width="+dd+"px height="+eval(theBase-tt)+"px style='vertical-align:bottom'></div>");
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:"+dd+"px;top:"+eval(theBase-tt)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "q_"+theColor+".gif' width="+eval(ww-dd)+"px height="+eval(bb-theBase)+"px style='vertical-align:bottom'></div>");
    }
    if (((theY0>theY1)&&(theX0<theX1))||((theY0<theY1)&&(theX0>theX1)))
    { _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:"+eval(theBase-tt)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "p_"+theColor+".gif' width="+eval(ww-dd)+"px height="+eval(bb-theBase)+"px style='vertical-align:bottom'></div>");
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:"+eval(ww-dd)+"px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "d_"+theColor+".gif' width="+dd+"px height="+eval(theBase-tt)+"px style='vertical-align:bottom'></div>");
    }
  }
  if (theBase>=bb)
  { if ((theBase>bb)&&(ww>0))
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:"+hh+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "o_"+theColor+".gif' width="+ww+"px height="+eval(theBase-bb)+"px style='vertical-align:bottom'></div>");
    if (((theY0<theY1)&&(theX0<theX1))||((theY0>theY1)&&(theX0>theX1)))
      _DiagramTarget.document.write("<div "+this.EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "b_"+theColor+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>");
    if (((theY0>theY1)&&(theX0<theX1))||((theY0<theY1)&&(theX0>theX1)))
...
{ var dd, ll, rr, tt, bb, ww, hh, id=this.ID,selObj="",divtext="";
  ...
  { if ((this.Base<tt)&&(ww>0))
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "o_"+this.Color+".gif' width="+ww+"px height="+eval(tt-this.Base)+"px style='vertical-align:bottom'></div>";
    if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:"+eval(tt-this.Base)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "q_"+this.Color+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>";
    if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
  ...
  { dd=Math.round((this.Base-tt)/hh*ww);
    if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
    { divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "b_"+this.Color+".gif' width="+dd+"px height="+eval(this.Base-tt)+"px style='vertical-align:bottom'></div>";
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:"+dd+"px;top:"+eval(this.Base-tt)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "q_"+this.Color+".gif' width="+eval(ww-dd)+"px height="+eval(bb-this.Base)+"px style='vertical-align:bottom'></div>";
    }
    if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
    { divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:"+eval(this.Base-tt)+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "p_"+this.Color+".gif' width="+eval(ww-dd)+"px height="+eval(bb-this.Base)+"px style='vertical-align:bottom'></div>";
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:"+eval(ww-dd)+"px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "d_"+this.Color+".gif' width="+dd+"px height="+eval(this.Base-tt)+"px style='vertical-align:bottom'></div>";
    }
  }
  if (this.Base>=bb)
  { if ((this.Base>bb)&&(ww>0))
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:"+hh+"px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "o_"+this.Color+".gif' width="+ww+"px height="+eval(this.Base-bb)+"px style='vertical-align:bottom'></div>";
    if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
      divtext+="<div "+this.EventActions+"style='"+this.Cursor+"position:absolute;left:0px;top:0px;font-size:1pt;line-height:1pt;'><img src='" + _DiagramImagesHref + "b_"+this.Color+".gif' width="+ww+"px height="+hh+"px style='vertical-align:bottom'></div>";
    if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
...
{ var x0,y0,i,j,itext,l,x,y,r,u,fn,dx,dy,xr,yr,invdifx,invdify,deltax,deltay,id=this.ID,lay=0,ii=0,oo,k,sub;
  ...
  var drawImg=_DiagramImagesHref+'transparent.gif';
        ...
        { itext++;
          ...
          { if (this.XScalePosition.substr(0,3)!="top")
            { if ((x0+sshift>=this.left)&&(x0+sshift<=this.right))
              ...
              writeln("<div style='position:absolute; left:"+eval(x0-this.left)+"; top:"+eval(this.bottom-5-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+"><img src='" + _DiagramImagesHref + "transparent.gif' width=1 height=12></td></tr></table></div>");
            }
            else
            { if ((x0+sshift>=this.left)&&(x0+sshift<=this.right))
              ...
              writeln("<div style='position:absolute; left:"+eval(x0-this.left)+"; top:-5; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+"><img src='" + _DiagramImagesHref + "transparent.gif' width=1 height=12></td></tr></table></div>");
            }
        ...
        { itext++;
          ...
          { if (this.YScalePosition.substr(0,5)!="right")
            { if ((y0+sshift>=this.top)&&(y0+sshift<=this.bottom))
              ...
              writeln("<div style='position:absolute; left:-5; top:"+eval(y0-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+" valign=top><img src='" + _DiagramImagesHref + "transparent.gif' height=1 width=11></td></tr></table></div>");
            }
            else
            { if ((y0+sshift>=this.top)&&(y0+sshift<=this.bottom))
              ...
              writeln("<div style='position:absolute; left:"+eval(this.right-this.left-5)+"; top:"+eval(y0-this.top)+"; font-size:1pt; line-height:1pt'><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theTextColor+" valign=top><img src='" + _DiagramImagesHref + "transparent.gif' height=1 width=11></td></tr></table></div>");
            }
...
{ this.ID="Bar"+_N_Bar; _N_Bar++; _zIndex++;
  ...
  if ((tt=="")||(tt==this.Text)) tt="<img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(this.width-1)+" height="+eval(this.height-1)+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  else tt=this.Text;
  if (_IsImage(this.Text)) tt="<img src='"+_DiagramImagesHref+this.Text+"' width="+eval(this.width-1)+" height="+eval(this.height-1)+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  var drawCol=(_nvl(theDrawColor,"")=="") ? "" : "bgcolor="+theDrawColor;
...
{ this.ID="Box"+_N_Box; _N_Box++; _zIndex++;
  ...
  var tt="";
  while (tt.length<this.Text.length) tt=tt+" ";
  if ((tt=="")||(tt==this.Text)) tt="<img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(this.width-(2*ww))+" height="+eval(this.height-(2*ww))+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  else tt=this.Text;
  if (_IsImage(this.Text)) tt="<img src='"+_DiagramImagesHref+this.Text+"' width="+eval(this.width-(2*ww))+" height="+eval(this.height-(2*ww))+" border=0 alt='"+_nvl(theTooltipText,"")+"'>";
  var drawCol=(_nvl(theDrawColor,"")=="") ? "" : "bgcolor="+theDrawColor;
  var textCol=(_nvl(theTextColor,"")=="") ? "" : "color:"+theTextColor+";";
...
{ var id=this.ID;
  ...
  var tt="";
  while (tt.length<this.Text.length) tt=tt+" ";
  if ((tt=="")||(this.Text==tt)) tt="<img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+" border=0 alt='"+_nvl(this.TooltipText,"")+"'>";
  else tt=this.Text;
  if (_IsImage(this.Text)) tt="<img src='"+_DiagramImagesHref+this.Text+"' width="+eval(this.width-2*ww)+" height="+eval(this.height-2*ww)+" border=0 alt='"+_nvl(this.TooltipText,"")+"'>";
...
{ this.Size=theSize;
  ...
  {  var cc=(_nvl(theColor,"")=="") ? "" : " bgcolor="+theColor;
    _DiagramTarget.document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td"+cc+"><a"+this.EventActions+"><img src='"+_DiagramImagesHref+theType+"' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
  }
  else
  { if (theType%6==0)
    { _DiagramTarget.document.writeln("<layer left=1 top="+Math.round(this.Size/4+0.3)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(this.Size-1)+" height="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></dt></tr></table></layer>");
    ...
    if (theType%6==2)
      _DiagramTarget.document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+theColor+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left></a></dt></tr></table></layer>");
    if (theType%6==3)
...
{ if (theColor!="") this.Color=theColor;
  ...
  { document.open();
    ...
    { var cc=(_nvl(this.Color,"")=="") ? "" : " bgcolor="+this.Color;
      document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td"+cc+"><a"+this.EventActions+"><img src='"+_DiagramImagesHref+theType+"' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
    }
    else   
    { if (this.Type%6==0)
      { document.writeln("<layer left=1 top="+Math.round(this.Size/4+0.3)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(this.Size-1)+" height="+eval(this.Size+1-2*Math.round(this.Size/4+0.3))+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      ...
      if (this.Type%6==2)
        document.writeln("<layer left=0 top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      if (this.Type%6==3)
      { document.writeln("<layer left=0 top="+Math.round(this.Size/4)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+Math.round(this.Size/2)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
        document.writeln("<layer left="+Math.round(this.Size/2-this.Size/8)+" top=0><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(this.Size/4)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
      }
      if (this.Type%6==4)
      { document.writeln("<layer left=0 top="+Math.round(this.Size/2-this.Size/8)+"><table noborder cellpadding=0 cellspacing=0><tr><td bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+Math.round(this.Size/4)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></dt></tr></table></layer>");
...
function nav_Pixel(theX, theY, theColor)
{ this.ID="Pix"+_N_Pix; _N_Pix++; _zIndex++;
  this.left=theX;
  this.top=theY;
  this.dX=2;
  ...
  this.MoveTo=_DotMoveTo;
  this.Delete=_Delete;
  _DiagramTarget.document.writeln("<layer id='"+this.ID+"' left="+eval(theX+this.dX)+" top="+eval(theY+this.dY)+" z-Index="+_zIndex+"><layer left=0 top=0 width=" + pixel_width + " height=" + pixel_height + " bgcolor="+theColor+"><img src='" + _DiagramImagesHref + "transparent.gif' width=" + pixel_width + " height=" + pixel_height + "></layer></layer>");
  return(this);
}
...
{ this.Color=theColor;
  with(_DiagramTarget.document.layers[this.ID])
  { document.open();
    document.writeln("<layer left=0 top=0 width=1 height=2 bgcolor="+theColor+"><img src='" + _DiagramImagesHref + "transparent.gif' width=1 height=2></layer>");
    document.close();
  }
}
...
{ this.ID="Line"+_N_Line; _N_Line++; _zIndex++;
  ...
  if ((ww==0)||(hh==0))
    _DiagramTarget.document.writeln("<layer left=2 top=2 width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
  else
  { if (ww>hh)
    { ccr=0;
      cct=0;
      ...
      { ccl=ccr;
        ...
        _DiagramTarget.document.writeln("<a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(ccr-ccl+this.Size)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
        cct++;
      }
    }
    else
    { ccb=0;
      ...
      { cct=ccb;
        ...
        _DiagramTarget.document.writeln("<a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+eval(ccb-cct+this.Size)+" border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
        ccl++;
      }
    }
  }           
...
{ var xx0, yy0, xx1, yy1, ll, rr, tt, bb, ww, hh, ccl, ccr, cct, ccb, id=this.ID;
  ...
  { top=tt-ss2;
    ...
    document.open();
    if ((ww==0)||(hh==0))
      document.writeln("<layer left=2 top=2 width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(ww+this.Size)+" height="+eval(hh+this.Size)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
    else
    { if (ww>hh)
      { ccr=0;
        cct=0;
        ...
        { ccl=ccr;
          ...
          document.writeln("<a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+eval(ccr-ccl+this.Size)+" height="+this.Size+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
          cct++;
        }
      }
      else
      { ccb=0;
        ...
        { cct=ccb;
          ...
          document.writeln("<a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+this.Size+" height="+eval(ccb-cct+this.Size)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
          ccl++;
        }
      }
    }
...
{ var dd, ll, rr, tt, bb, ww, hh, id=this.ID;
  ...
  { if (this.Base<=tt) { left=ll; top=this.Base; }
    ...
    if (this.Base<=tt)
    { if ((this.Base<tt)&&(ww>0))
        document.writeln("<layer left=2 top=2><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "o_"+this.Color+".gif' width="+ww+" height="+eval(tt-this.Base)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
        document.writeln("<layer left=2 top="+eval(tt-this.Base+2)+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "q_"+this.Color+".gif' width="+ww+" height="+hh+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
    ...
    { dd=Math.round((this.Base-tt)/hh*ww);
      if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
      { document.writeln("<layer left=2 top=2><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "b_"+this.Color+".gif' width="+dd+" height="+eval(this.Base-tt)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
        document.writeln("<layer left="+eval(dd+2)+" top="+eval(this.Base-tt+2)+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "q_"+this.Color+".gif' width="+eval(ww-dd)+" height="+eval(bb-this.Base)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      }
      if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
      { document.writeln("<layer left=2 top="+eval(this.Base-tt+2)+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "p_"+this.Color+".gif' width="+eval(ww-dd)+" height="+eval(bb-this.Base)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
        document.writeln("<layer left="+eval(ww-dd+2)+" top=2><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "d_"+this.Color+".gif' width="+dd+" height="+eval(this.Base-tt)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      }
    }
    if (this.Base>=bb)
    { if ((this.Base>bb)&&(ww>0))
        document.writeln("<layer left=2 top="+eval(hh+2)+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "o_"+this.Color+".gif' width="+ww+" height="+eval(this.Base-bb)+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      if (((this.Y0<this.Y1)&&(this.X0<this.X1))||((this.Y0>this.Y1)&&(this.X0>this.X1)))
        document.writeln("<layer left=2 top=2><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "b_"+this.Color+".gif' width="+ww+" height="+hh+" border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
      if (((this.Y0>this.Y1)&&(this.X0<this.X1))||((this.Y0<this.Y1)&&(this.X0>this.X1)))
    ...
    { xx=Math.round(Math.sqrt(rr2-(yy+0.5)*(yy+0.5)));
      ...
      { if ((yy<yy0)&&(yy<yy1))
        { if (((xx0<0)&&(xx1>0))||((xx0<0)&&(xx1<=xx0))||((xx1>0)&&(xx0>=xx1)))
          ...
          ss1=yy*xx1/yy1;
          if (xx0<xx1)
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(ss1-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss1-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          else
          { _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss1+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss1+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(xx-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(xx-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          }
        }
        else if (yy>=yy0)
        { ss0=yy*xx0/yy0;
    ...
    { xx=Math.round(Math.sqrt(rr2-(yy+0.5)*(yy+0.5)));
      ...
      { if ((yy>yy0)&&(yy>yy1))
        { if (((xx1<0)&&(xx0>0))||((xx1<0)&&(xx0<=xx1))||((xx0>0)&&(xx1>=xx0)))
          ...
          ss1=yy*xx1/yy1;
          if (xx0>xx1)
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(ss0-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss0-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          else
          { _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss0+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss0+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
            _DiagramTarget.document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(xx-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(xx-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(theTooltipText,"")+"'></a></layer>");
          }
        }
        else if (yy<=yy0)
        { ss0=yy*xx0/yy0;
      ...
      { xx=Math.round(Math.sqrt(rr2-(yy+0.5)*(yy+0.5)));
        ...
        { if ((yy<yy0)&&(yy<yy1))
          { if (((xx0<0)&&(xx1>0))||((xx0<0)&&(xx1<=xx0))||((xx1>0)&&(xx0>=xx1)))
            ...
            ss1=yy*xx1/yy1;
            if (xx0<xx1)
              document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(ss1-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss1-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            else
            { document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss1+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss1+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
              document.writeln("<layer left="+Math.round(this.Radius+2+ss0)+" top="+tt+" width="+Math.round(xx-ss0)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(xx-ss0)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            }
          }
          else if (yy>=yy0)
          { ss0=yy*xx0/yy0;
      ...
      { xx=Math.round(Math.sqrt(rr2-(yy+0.5)*(yy+0.5)));
        ...
        { if ((yy>yy0)&&(yy>yy1))
          { if (((xx1<0)&&(xx0>0))||((xx1<0)&&(xx0<=xx1))||((xx0>0)&&(xx1>=xx0)))
            ...
            ss1=yy*xx1/yy1;
            if (xx0>xx1)
              document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(ss0-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss0-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            else
            { document.writeln("<layer left="+Math.round(this.Radius+2-xx)+" top="+tt+" width="+Math.round(ss0+xx)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(ss0+xx)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
              document.writeln("<layer left="+Math.round(this.Radius+2+ss1)+" top="+tt+" width="+Math.round(xx-ss1)+" height=1 bgcolor="+this.Color+"><a"+this.EventActions+"><img src='" + _DiagramImagesHref + "transparent.gif' width="+Math.round(xx-ss1)+" height=1 border=0 align=top valign=left alt='"+_nvl(this.TooltipText,"")+"'></a></layer>");
            }
          }
          else if (yy<=yy0)
          { ss0=yy*xx0/yy0;
...
if (_nav4) {
	...
	Bar = nav_Bar;
	Box = nav_Box;
	_SetBarColor = nav_SetBarColor;
	_SetBarText = nav_SetBarText;
	Dot = nav_Dot;
	_SetDotColor = nav_SetDotColor;
	_DotMoveTo = nav_DotMoveTo;
	Pixel = nav_Pixel;
	_SetPixelColor = nav_SetPixelColor;
	_SetVisibility = nav_SetVisibility;
	_SetTitle = nav_SetTitle;
	_MoveTo = nav_MoveTo;
	_ResizeTo = nav_ResizeTo;
	_Delete = nav_Delete;
	_SetColor = nav_SetColor;
	Line = nav_Line;
	_LineResizeTo = nav_LineResizeTo;
	_LineMoveTo = nav_LineMoveTo;
	Area = nav_Area;
	_AreaResizeTo = nav_AreaResizeTo;
	Arrow = nav_Arrow;
	_ArrowResizeTo = nav_ArrowResizeTo;
	_ArrowMoveTo = nav_ArrowMoveTo;
	Pie = nav_Pie;
	_PieResizeTo = nav_PieResizeTo;
	_PieMoveTo = nav_PieMoveTo;
} else {
	_Draw = dom_Draw;
	Bar = dom_Bar;
	Box = dom_Box;
	_SetBarColor = dom_SetBarColor;
	_SetBarText = dom_SetBarText;
	Dot = dom_Dot;
	_SetDotColor = dom_SetDotColor;
	_DotMoveTo = dom_DotMoveTo;
	Pixel = dom_Pixel;
	_SetPixelColor = dom_SetPixelColor;
	_SetVisibility = dom_SetVisibility;
	_SetTitle = dom_SetTitle;
	_MoveTo = dom_MoveTo;
	_ResizeTo = dom_ResizeTo;
	_Delete = dom_Delete;
	_SetColor = dom_SetColor;
	Line = dom_Line;
	_LineResizeTo = dom_LineResizeTo;
	_LineMoveTo = dom_LineMoveTo;
	Area = dom_Area;
	_AreaResizeTo = dom_AreaResizeTo;
	Arrow = dom_Arrow;
	_ArrowResizeTo = dom_ArrowResizeTo;
	_ArrowMoveTo = dom_ArrowMoveTo;
	Pie = dom_Pie;
	_PieResizeTo = dom_PieResizeTo;
	_PieMoveTo = dom_PieMoveTo;
}

var _DiagramImagesHref = '';
