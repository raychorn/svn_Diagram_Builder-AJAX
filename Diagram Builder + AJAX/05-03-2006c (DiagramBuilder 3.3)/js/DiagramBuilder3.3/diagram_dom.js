...
{ this.ID="Box"+_N_Box; _N_Box++; _zIndex++;
  ...
  if (_nvl(theText,"")!="")
  { var tt=theText;
    if (_IsImage(theText)) tt="<img src='"+_DiagramImagesHref+theText+"' width="+Math.abs(eval(theRight-theLeft-2*ww))+" height="+Math.abs(eval(theBottom-theTop-2*ww))+">";
    _DiagramTarget.document.writeln("<div id='"+this.ID+"' "+EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:"+theLeft+"px;top:"+theTop+"px;width:"+Math.abs(eval(theRight-theLeft-ww+ww*_dSize))+"px;height:"+Math.abs(eval(theBottom-theTop-ww+ww*_dSize))+"px;"+bb+"background-color:"+theDrawColor+";color:"+theTextColor+";"+_BFont+"z-index:"+_zIndex+"'; title='"+_nvl(theTooltipText,"")+"' align=center>"+tt+"</div>");
  }
  else
  { var vv=(this.height>=2*ww) ? "" : ";visibility:hidden";
    _DiagramTarget.document.writeln("<div id='"+this.ID+"' "+EventActions+"style='"+_cursor(theOnClickAction)+"position:absolute;left:"+theLeft+"px;top:"+theTop+"px;width:"+Math.abs(eval(theRight-theLeft-ww+ww*_dSize))+"px;height:"+Math.abs(eval(theBottom-theTop-ww+ww*_dSize))+"px;"+bb+"background-color:"+theDrawColor+";font-size:1pt;line-height:1pt;font-family:Verdana;font-weight:normal;z-index:"+_zIndex+vv+"'; title='"+_nvl(theTooltipText,"")+"'>&nbsp;</div>");
  }
  return(this);
}
